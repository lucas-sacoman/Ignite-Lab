...
import imgMock from '/src/assets/code-mockup.png';
// import reactLogo from '/src/assets/code-mockup.png';
	...
	return (
		<>
			<div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
				{/* <img src={reactLogo} className="mt-10 absolute" alt="" /> */}
				<div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto flex-col md:flex-row p-5 md:p-0">
					<div className="max-w-[640px] md:w-full">
						<div className="flex justify-center md:block">{/* <Logo /> */}</div>
